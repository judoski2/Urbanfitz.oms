...
const API = {
  ...
  // Measurements
  getMeasurements: () => API.get('/api/measurements'),
  getMeasurement: (phone) => API.get('/api/measurements/' + encodeURIComponent(phone)),
  saveMeasurement: (data) => API.post('/api/measurements', data),
  deleteMeasurement: (phone) => API.del('/api/measurements/' + encodeURIComponent(phone)),
};
